...
function getFontFamily(theme: FontTheme): string {
  ...
  // - macOS/iOS/iPadOS: -apple-system / BlinkMacSystemFont resolves to SF Pro
  // - Android/Chrome OS: Roboto
  // - Linux: Falls through to Roboto, Helvetica Neue, or Arial
  const fontMap = {
    default: '-apple-system, BlinkMacSystemFont, "Segoe UI Variable", "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
