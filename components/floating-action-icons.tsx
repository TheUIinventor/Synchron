...
export default function FloatingActionIcons() {
  ...
  return (
    <div className="fixed z-50 flex flex-col gap-6 right-4 bottom-8 items-end pointer-events-none">
      <div className={"pointer-events-auto transition-transform duration-300 hover:scale-105 rounded-full p-4 w-16 h-16 flex items-center justify-center glass-button backdrop-blur-xl bg-white/60 dark:bg-gray-900/60 shadow-lg border border-white/30 dark:border-gray-800/40"}>
        <AuthButton />
      </div>
      <div className={"pointer-events-auto transition-transform duration-300 hover:scale-105 rounded-full p-4 w-16 h-16 flex items-center justify-center glass-button backdrop-blur-xl bg-white/60 dark:bg-gray-900/60 shadow-lg border border-white/30 dark:border-gray-800/40"}>
        <SettingsMenu />
