            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="rounded-full bg-primary/10 text-primary px-3 py-1 text-sm">Now</span>
                </div>
                <div className="text-muted-foreground">{/* location icon placeholder */}</div>
              </div>
              <CardTitle className={`${bagel.className} text-5xl`}>HIS B</CardTitle>
              <CardDescription>402 • PAUV</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mt-6">
                <div className="h-3 bg-primary/20 rounded-full">
                  <div className="h-3 bg-primary rounded-full" style={{ width: '55%' }} />
                </div>
                ...
                {[
                  ...
                  <div key={item.time} className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="rounded-lg bg-muted/20 p-4">{item.title}<div className="text-xs text-muted-foreground mt-1">{item.room}</div></div>
                    </div>
                  </div>
                ))}
              </div>
