                              ...
                              <div className="flex-1">
                                <div className="flex items-center justify-between gap-3">
                                  ...
                                  <div className="flex items-center gap-3 min-w-0">
                                    <div className={`rounded-lg px-2 py-0.5 text-xs font-semibold flex-shrink-0 text-center ${getSubjectColor((period as any).title || period.subject)}`}>
                                      <span className="block text-xs font-semibold leading-none">{(period as any)?.title || period.subject}</span>
                                    </div>
                                  </div>
